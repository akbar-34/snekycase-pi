  ...
  return (
    <div className="bg-white">
      <div className="mx-auto max-w-3xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        ...
        <div className="mt-10 border-t border-zinc-200">
          <div className="mt-10 flex flex-auto flex-col">
            ...
            <p className="mt-2 text-sm text-zinc-600">
              We at SnekyCase believe that a phone case doesn't only need to
        ...
        <div className="flex space-x-6 overflow-hidden mt-4 rounded-xl lg:rounded-2xl">
          {/* <PhonePreview
          ...
          <Phone
            className={cn(
              `bg-${tw}`,
              "max-w-[200px] mx-auto flex justify-center items-center"
            )}
          ...
          <div className="grid grid-cols-2 gap-x-6 border-t border-zinc-200 py-10 text-sm">
            ...
            <div>
              ...
              <p className="mt-2 text-zinc-700">
                JNE, takes up to 3 working days
              </p>
            </div>
          </div>
        </div>
