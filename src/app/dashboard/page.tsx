...
import StatusDropdown from "./StatusDropdodwn";
        ...
        <div className='flex flex-col gap-16'>
          <div className='grid gap-4 sm:grid-cols-2'>
            <Card>
              ...
              <CardContent>
                <div className='text-sm text-muted-foreground'>
                  dari target {formatPrice(WEEKLY_GOAL)} 
                </div>
              </CardContent>
              <CardFooter>
                <Progress
            ...
            <Card>
              ...
              <CardContent>
                <div className='text-sm text-muted-foreground'>
                  dari target {formatPrice(MONTHLY_GOAL)} 
                </div>
              </CardContent>
              <CardFooter>
                <Progress
          ...
          <h1 className='text-4xl font-bold tracking-tight'>Orderan masuk</h1>
