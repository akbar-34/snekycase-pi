...
const Page = () => {
  ...
  const onDropRejected = (rejectedFiles: FileRejection[]) => {
    ...
    toast({
      title: `${file.file.type} format tidak support.`,
      description: "Gunakan gambar berformat PNG, JPG, atau JPEG",
      variant: "destructive",
    });
  };
            ...
            <div
              ...
              <div className="flex flex-col justify-center mb-2 text-sm text-zinc-700">
                {isUploading ? (
                  ...
                  <div className="flex flex-col items-center">
                    <p>Redirecting, mohon tunggu...</p>
                  </div>
                ) : isDragOver ? (
                  <p>
                    <span className="font-semibold">Drop file</span> untuk
                    upload
                  </p>
                ) : (
                  <p>
